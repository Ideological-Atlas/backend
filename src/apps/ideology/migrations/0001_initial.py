# Generated by Django 6.0 on 2026-01-29 00:04
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        db_index=True,
                        editable=False,
                        help_text="SHA-256 hash of the normalized answers for fast deduplication.",
                        max_length=64,
                        verbose_name="Answer Hash",
                    ),
                ),
                (
                    "completed_by",
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=list,
                        help_text="List of valid options if the type is 'Categorical'. Format: ['Option A', 'Option B']. For 'Derived from Axis Range', this is auto-set to ['true', 'false'].",
                        null=True,
                ...
                (
                    ...
                    models.IntegerField(
                        blank=True,
                        help_text="Condition is met if user value >= this.",
                        null=True,
                        verbose_name="Min Value (Inclusive)",
                    ),
                ),
                (
                    "axis_max_value",
                    models.IntegerField(
                        ...
                        help_text="Condition is met if user value <= this.",
                        null=True,
                        verbose_name="Max Value (Inclusive)",
                    ),
                ),
                (
                    "source_axis",
                    models.ForeignKey(
                        blank=True,
                        help_text="Only for AXIS_RANGE type. The axis to watch.",
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="derived_conditioners",
                        to="ideology.ideologyaxis",
                        verbose_name="Source Axis",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "unique_together": {
                    ("target_conditioner", "conditioner", "name"),
                    ("target_conditioner", "conditioner", "name_en"),
                    ("target_conditioner", "conditioner", "name_es"),
                },
            },
        ),
        migrations.AddField(
