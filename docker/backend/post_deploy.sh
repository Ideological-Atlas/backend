...
# Load fixtures
python3 manage.py loaddata ideologies ideology_abstraction_complexities ideology_axes ideology_conditioners ideology_sections ideology_axis_definitions
